...
class PairFactoryTraining(PairFactoryBase):
    ...
    def _get_next_pair(self):
        ...
        while True:
            ...
            #             # Each function is identified via a IDB and FVA
            #             idb, fva = func
            #             if idb not in self._fdict or fva not in self._fdict[idb] or "idx_list" not in self._fdict[idb][fva]:
            #                 print("!!!!!!training!!!!!!!IDB missing {}".format(idb))
            #             f_list.append("1;2;683;684;731;732")
