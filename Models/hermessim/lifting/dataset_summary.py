...
if __name__ == "__main__":
    ...
    for idb_path, finfos in tqdm(summary.items()):
        ...
        for finfo in finfos:
            ...
            # ###############DEBUG################
            # if fva not in acfg_feats:
            #     finfo["edges"] = [[78181, 78208], [78176, 78224], [78181, 78232], [78176, 78181]]
            #     bb_va_hex = 0x2c60
            #     finfo["nodes"].append(['0x2c60', 8])
            #     print("!!!!!fva missing!!!!!"+idb_path)
            #     print("fva:"+fva)
            #     print("cfgs_folder:"+cfgs_folder)
            # elif "edges" not in acfg_feats[fva]:
            #     finfo["edges"] = [[78181, 78208], [78176, 78224], [78181, 78232], [78176, 78181]]
            #     print("!!!!!edges missing!!!!!**************"+idb_path)
            #     print("cfgs_folder:"+cfgs_folder)
            #     print("fva:"+fva)
            # else:
