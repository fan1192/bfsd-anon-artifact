...
# Paths to clear
OUT_TESTING="${BASE}/testing/acfg_features_${DATASET}_testing"
OUT_TRAINING="${BASE}/training/acfg_features_${DATASET}_training"
OUT_VALIDATION="${BASE}/validation/acfg_features_${DATASET}_validation"
...
########################################
# Run ACFG feature extraction
########################################

python3 "$SCRIPT_DIR/cli_acfg_features.py" \
